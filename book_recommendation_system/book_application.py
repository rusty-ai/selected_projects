...
def on_draw():
    ...
    if STATE == "MENU":
        ...
        pyglet.shapes.Rectangle(x=window.width//2 - 300, y=window.height//2 + 100, width=600, height=30, color=(180, 180, 180)).draw() # color under the text input
        pyglet.text.HTMLLabel(label_book, x=window.width//2 - 290, y=window.height//2 + 108).draw()
        ...
        pyglet.shapes.Rectangle(x=window.width//2 - 300, y=window.height//2 + 30, width=70, height=30, color=(180, 180, 180)).draw() # color under the age input
        pyglet.text.HTMLLabel(label_age, x=window.width//2 - 290, y=window.height//2 + 38).draw()
        ...
        pyglet.shapes.Rectangle(x=window.width//2 - 300, y=window.height//2 - 40, width=200, height=30, color=(180, 180, 180)).draw() # color under the country input
        pyglet.text.HTMLLabel(label_country, x=window.width//2 - 290, y=window.height//2 - 32).draw()

    if STATE == "RESULTS":

        pyglet.shapes.Rectangle(x=window.width//2 - 300, y=window.height//2 + 100, width=600, height=30, color=(180, 180, 180)).draw() # box under the SUGGESTED_BOOK
        label_book = "<font face='Calibri'><b>Title: </b>" + SUGGESTED_BOOK + "</font>"
        pyglet.text.HTMLLabel(label_book, x=window.width//2 - 290, y=window.height//2 + 108).draw()

        pyglet.shapes.Rectangle(x=window.width//2 - 300, y=window.height//2 - 230, width=600, height=300, color=(180, 180, 180)).draw() # box under the results
        ...
        pyglet.text.HTMLLabel("<font face='Calibri'><b>Year of publication: </b><i>" + str(int(df_recommendations["Year-Of-Publication"].tolist()[BOOK_TO_SHOW])), 
                              x=window.width//2 - 290, y=window.height//2 - 222 + 270 - 60).draw()
        ...
        if SHOW_IMG == True:
            ...
            if os.path.exists("resources/book_image.jpg"):
                ...
                book_image.blit(x=window.width//2 - 290, y=window.height//2 - 220, z=0)
