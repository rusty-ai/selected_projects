My jupyterlab notebook with a variational autoencoder with residual connections and a custom energy loss, used in my Mgr thesis (which will be finished this autumn). 
